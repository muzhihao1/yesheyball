...
async function finalComplete338() {
  ...
  for (const levelInfo of levels) {
      ...
      if (!requirements[key]) {
        ...
        if (fs.existsSync(imagePath)) {
          ...
          if (requirement) {
            ...
            console.log(`第${levelInfo.level}级第${exercise}题: ${requirement}`);
            successful++;
    ...
    console.log(`${levelInfo.folder}: ${levelCount}/${levelInfo.exercises} 完成\n`);
  }
...
finalComplete338().catch(console.error);