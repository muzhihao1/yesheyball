...
async function continuousFullExtraction() {
  ...
  console.log(`\n总完成度: ${totalAuth}/${total} (${(totalAuth/total*100).toFixed(1)}%)`);
  console.log(`成功提取 ${totalAuth} 个真实描述`);
}

continuousFullExtraction().catch(console.error);