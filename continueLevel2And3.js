...
async function continueLevel2And3() {
  ...
  console.log("继续验证第2级和第3级剩余习题...\n");

  // 完成第2级剩余习题 (28-40)
  for (let exercise = 28; exercise <= 40; exercise++) {
...
continueLevel2And3().catch(console.error);