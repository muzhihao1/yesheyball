...
async function continueLevel6() {
  ...
  const startFrom = Object.keys(requirements).filter(k => k.startsWith('6-')).length + 1;
  console.log(`继续等级6验证工作，从第${startFrom}题开始`);
  ...
  console.log(`等级6验证进度: ${level6Count}/60`);
...
continueLevel6().catch(console.error);