...
async function continueLevel4From23() {
  ...
  console.log(`等级4验证结果: ${level4Count}/60`);
  console.log(`总进度: ${finalCount}/415 (${Math.round(finalCount/415*100)}%)`);
  
  if (level4Count === 60) {
    console.log('\n等级4 (炉火纯青) 验证完成！');
  } else {
    console.log(`还需验证: ${60 - level4Count} 个习题`);
  }
}

continueLevel4From23().catch(console.error);