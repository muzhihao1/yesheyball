...
async function processRemaining() {
  ...
  // Process only 10 exercises to avoid timeout (22-31)
  for (let i = 22; i <= 31; i++) {
    const key = `2-${i}`;
  ...
  console.log(`Completed exercises 22-31: ${updated} updates`);
  ...
  console.log(`Level 2 status: ${authentic}/40 authentic descriptions`);
}
