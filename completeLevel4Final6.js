...
async function completeLevel4Final6() {
  ...
  console.log(`完成等级4最后6个习题验证 (55-60)`);
  ...
  console.log(`等级4最终结果: ${level4Count}/60`);
  console.log(`总进度: ${finalCount}/415 (${Math.round(finalCount/415*100)}%)`);
  
  if (level4Count === 60) {
    console.log('\n等级4 (炉火纯青) 验证完成！');
    console.log('前四个等级全部完成验证');
  }
}

completeLevel4Final6().catch(console.error);