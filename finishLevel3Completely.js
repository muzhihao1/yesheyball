...
async function finishLevel3Completely() {
  const descriptionsPath = 'client/src/data/exerciseDescriptions.json';
  let descriptions = JSON.parse(fs.readFileSync(descriptionsPath, 'utf8'));
  
  console.log('完成Level 3最后习题 (26-50)...');
  ...
  console.log(`Level 3 完成度: ${authentic}/50 (${(authentic/50*100).toFixed(1)}%)`);
}

finishLevel3Completely().catch(console.error);