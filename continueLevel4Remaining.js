...
async function continueLevel4Remaining() {
  ...
  console.log(`继续等级4验证 - 当前: ${startCount}/415`);
  ...
  console.log(`等级4完成度: ${level4Count}/60`);
  console.log(`总进度: ${finalCount}/415 (${Math.round(finalCount/415*100)}%)`);
  
  if (level4Count === 60) {
    console.log('\n等级4 (炉火纯青) 全部验证完成！');
  } else {
    console.log(`等级4还需验证: ${60 - level4Count} 个习题`);
  }
}

continueLevel4Remaining().catch(console.error);