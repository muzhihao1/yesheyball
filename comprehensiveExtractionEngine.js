...
async function comprehensiveExtractionEngine() {
  ...
  console.log('综合提取引擎启动：完成161题...');
  
  let completed = 0;
  
  // Process Level 6 from exercise 26
  for (let i = 26; i <= 60; i++) {
    const key = `6-${i}`;
  ...
  console.log(`综合提取引擎完成: ${completed} 个描述`);
