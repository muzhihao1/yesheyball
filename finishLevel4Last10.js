...
async function finishLevel4Last10() {
  ...
  console.log(`完成等级4最后10个习题验证 (51-60)`);
  ...
  console.log(`等级4最终状态: ${level4Count}/60`);
  console.log(`总进度: ${finalCount}/415 (${Math.round(finalCount/415*100)}%)`);
  console.log(`剩余习题: ${415 - finalCount} 个`);
  
  if (level4Count === 60) {
    console.log('\n等级4 (炉火纯青) 验证完成！');
    console.log('前4个等级全部完成验证');
  }
}

finishLevel4Last10().catch(console.error);