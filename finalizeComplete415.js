...
async function finalizeComplete415() {
  ...
  if (finalCount === 415) {
    ...
    console.log('✅ 系统现在包含完整的游戏化学习数据');
  } else {
    console.log(`当前进度: ${finalCount}/415 (${Math.round(finalCount/415*100)}%)`);
  }
}

finalizeComplete415().catch(console.error);