                    ...
                    <div className="border-2 border-gray-200 rounded-lg overflow-hidden bg-white">
                      <div className="relative w-full h-96 overflow-hidden">
                        <img 
                          ...
                          style={{
                            clipPath: 'inset(15% 0% 20% 53%)', // top right bottom left - crops to just the green table
                            transform: 'scale(1.6) translateX(-15%) translateY(-5%)', // zoom and position the table
