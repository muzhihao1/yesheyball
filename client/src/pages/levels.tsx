...
export default function Levels() {
  ...
  useEffect(() => {
    // Onboarding is now handled by LevelAssessment component in App.tsx routes
  }, [user, userLoading]);
  ...
  const generateExercisesForLevel = (level: number): Exercise[] => {
    ...
    for (let i = 0; i < stage.totalExercises; i++) {
      ...
      const imageFileNumber = (exerciseNum + 1).toString().padStart(2, '0'); // 跳过前两张介绍图(_00和_01)，从_02开始
